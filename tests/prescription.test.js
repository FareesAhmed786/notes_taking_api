...
let baseUrlM = "http://localhost:3000/medicines";
let baseUrl = "http://localhost:3000/prescriptions";
let server;
...
describe('prescription Endpoints', () => {
    ...
    let prescriptionId1, prescriptionId2;
    ...
    it('should create a new medicine 1', async () =>
        await processData(baseUrlM, medicineBodyData1)
            .then((data) => {
                console.log(data);
    ...
    it('should create a new medicine 2', () => {
        return processData(baseUrlM, medicineBodyData2)
            .then((data) => {
                console.log(data);
    ...
    it('should create a new prescription 1', async () => {
        const bodyData = {
            patientUid: patientId1,
            doctorUid: doctorId1,
        ...
        return await processData(baseUrl, bodyData)
            .then((data) => {
                console.log(data);
                prescriptionId1 = data?.data?.prescriptionUid ?? "";
                expect(data.success).toBe(true);
            });
    });

    it('should create a new prescription 2', async () => {
        const bodyData = {
            patientUid: patientId2,
            doctorUid: doctorId2,
            medicines: [medicineId2],
            treatmentUid: treatmentId2,
        }
        return await processData(baseUrl, bodyData)
            .then((data) => {
                console.log(data);
                prescriptionId2 = data?.data?.prescriptionUid ?? "";
                expect(data.success).toBe(true);
            });
    });

    it('should list all prescription  ', () => {
        return processData(baseUrl, {}, "GET")
            .then((data) => {
                console.log(data);
                expect(data.success).toBe(true);
    ...
    it('should give second prescription data', () => {
        return processData(`${baseUrl}/${prescriptionId2}`, {}, "GET")
            .then((data) => {
                console.log(data);
                expect(data.success).toBe(true);
            });
    ...
    it('should update name of prescription 1', async () => {
        const updateData = {prescriptionName: "updated"};
        return await processData(`${baseUrl}/${prescriptionId1}`, updateData, "PUT")
            .then((data) => {
                console.log(data);
                expect(data.success).toBe(true);
            });
    ...
    it('should delete prescription 1', async () =>
        await processData(`${baseUrl}/${prescriptionId1}`, {}, "DELETE")
            .then((data) => {
                console.log(data);
                expect(data.success).toBe(true);
            }));

    it('should delete prescription 2', async () =>
        await processData(`${baseUrl}/${prescriptionId2}`, {}, "DELETE")
            .then((data) => {
                console.log(data);
                expect(data.success).toBe(true);
            }));
    ...
    it('should delete medicine 1', async () =>
        await processData(`${baseUrlM}/${medicineId1}`, {}, "DELETE")
            .then((data) => {
                console.log(data);
                expect(data.success).toBe(true);
            }));
    ...
    it('should delete medicine 2', async () =>
        await processData(`${baseUrlM}/${medicineId2}`, {}, "DELETE")
            .then((data) => {
                console.log(data);
                expect(data.success).toBe(true);
            }));
